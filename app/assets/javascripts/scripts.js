/** ********************************************** **
	...
	-------------------------------
		COUNT TO
			https://github.com/mhuggins/$-countTo
...
*************************************************** **/
	...
	$(window).ready(function () {
		...
		// $ 3.x do no support size() - should be replaceced with .length
		...
		/* --- */
		if($("body").hasClass("smoothscroll") && navigator.platform.indexOf('Mac') < 0) {
 ...
 **************************************************************** **/
	function _slider_full() {
		...
		_screenHeight = $(window).height() - _headerHeight;

		if($("#header").hasClass('static'))
			_screenHeight = $(window).height();

		if($("#slider").hasClass('halfheight')) {
			$("#slider.halfheight").height(_screenHeight / 2);
		}

		if($("#slider").hasClass('thirdheight')) {
			$("#slider.thirdheight").height(_screenHeight / 1.5);
		}

		if($("#slider").hasClass('fullheight')) {
			$("#slider.fullheight").height(_screenHeight);
			$("#slider.fullheight-min").css({"min-height":_screenHeight + "px"});
		}

		if(window.width < 960) {
			$("#slider.mobile-fullheight").height(_screenHeight);
		}
	}
	...
	function _topNav() {
		...
		$("button.btn-mobile").bind("click", function(e) {
			...
			if($(this).hasClass('btn-mobile-active')) {
				...
				if(!$("#topMain").hasClass('nav-onepage') || window.width > 960) { /* onepage fix */
		...
		if(_header_el.hasClass('sticky')) {
			...
			if(_header_el.hasClass('transparent')) {
				var _el 					= $("#topNav div.nav-main-collapse"),
		...
		/** OVERLAY MENU
		 *************************** **/
		if($("#menu_overlay_open").length > 0) {
			var is_ie9 = $('html').hasClass('ie9') ? true : false;
		 ...
		 *************************** **/
		// RTL supported!
		if($("#sidebar_vertical_btn").length > 0) {
			if($("body").hasClass('menu-vertical-hide')) {

				// Determine the position (left or right?)
				_paddingStatusL = $("#mainMenu.sidebar-vertical").css('left');
				_paddingStatusR = $("#mainMenu.sidebar-vertical").css('right');
				...
				$("#sidebar_vertical_btn").bind("click", function(e) {
					...
					_paddingStatus = $("#mainMenu.sidebar-vertical").css(_pos);

					if(parseInt(_paddingStatus) < 0) {
						if(_pos == "right") {
							$("#mainMenu.sidebar-vertical").stop().animate({"right":"0px"}, 200);
						} else {
							$("#mainMenu.sidebar-vertical").stop().animate({"left":"0px"}, 200);
						}
					} else {
						if(_pos == "right") {
							$("#mainMenu.sidebar-vertical").stop().animate({"right":"-263px"}, 200);
						} else {
							$("#mainMenu.sidebar-vertical").stop().animate({"left":"-263px"}, 200);
						}
					}
				});
				...
				$(window).scroll(function() {
					...
					_paddingStatus = parseInt($("#mainMenu.sidebar-vertical").css(_pos));
		...
		$(window).scroll(function() {
			if(window.width < 769) {
				// hide quick cart if visible
				if ($('#header li.quick-cart div.quick-cart-box').is(":visible")) {
					$('#header li.quick-cart div.quick-cart-box').fadeOut(0);
				}
				// hide search if visible
				if($('#header li.search .search-box').is(":visible")) {
					$('#header .search-box').fadeOut(0);
				}
			}
		});
	}
 ...
 **************************************************************** **/
	function _megaNavHorizontal() {
		...
		// WRAPPER MAIN MENU
		if($("#wrapper nav.main-nav").length > 0) {

			var _sliderWidth 	= $("#slider").width(),
				_sliderHeight 	= $("#wrapper nav.main-nav").height();

			// Submenu widh & height
			$("#wrapper nav.main-nav>div>ul>li>.main-nav-submenu").css({"min-height":_sliderHeight+"px"});
			$("#wrapper nav.main-nav>div>ul>li.main-nav-expanded>.main-nav-submenu").css({"width":_sliderWidth+"px"});

			// SUBMENUS
			$("#wrapper nav.main-nav>div>ul>li").bind("click", function(e) {
				var _this = $(this);

				if(!$('div', _this).hasClass('main-nav-open')) {
					$("#wrapper nav.main-nav>div>ul>li>.main-nav-submenu").removeClass('main-nav-open');
				}

				$('div', _this).toggleClass('main-nav-open');
			});
		...
		// HEADER MAIN MENU
		var _hsliderWidth 	= $("#header>.container").width() - 278,
			_hsliderHeight 	= $("#header nav.main-nav").height();

		// Submenu widh & height
		$("#header nav.main-nav>div>ul>li>.main-nav-submenu").css({"min-height":_hsliderHeight+"px"});
		$("#header nav.main-nav>div>ul>li.main-nav-expanded>.main-nav-submenu").css({"width":_hsliderWidth+"px"});


		// SUBMENUS
		$("#header nav.main-nav>div>ul>li").bind("click", function(e) {
			var _this = $(this);

			if(!$('div', _this).hasClass('main-nav-open')) {
				$("#header nav.main-nav>div>ul>li>.main-nav-submenu").removeClass('main-nav-open');
			}
		...
		if(window.width > 767) { //  desktop|tablet
			...
			$("#header button.nav-toggle").mouseover(function(e) {
				e.preventDefault();
			...
			$("#header button.nav-toggle").bind("click", function(e) {
				e.preventDefault();
        ...
        $('body').on('click', '#header button.nav-toggle, #header nav.main-nav', function (e) {
            e.stopPropagation();
        });

        $("#header button.nav-toggle, #header nav.main-nav").mouseover(function(e) {
        	 e.stopPropagation();
        });
		...
		function _initMainNav() {
			...
			// add overlay
			$('body').append('<div id="main-nav-overlay"></div>');

			// Mobile menu open|close on click
			$('#header button.nav-toggle-close').bind("click", function() {
				$("#header nav.main-nav").removeClass('min-nav-active');
			});

			// Close menu on hover
	        $("#main-nav-overlay, #header").mouseover(function() {
		...
		// Menu Click
		$("nav.main-nav>div>ul>li a").bind("click", function(e) {
 ...
 **************************************************************** **/
	function _sideNav() {
		...
		/* Submenus */
		$("div.side-nav li>a.dropdown-toggle").bind("click", function(e) {
			e.preventDefault();
 ...
 **************************************************************** **/
	function _onepageNav() {
		...
		// Top Navigation
		var _container1 = $(".nav-onepage");

		if(_container1.length > 0) {

			loadScript(plugin_path + 'nav.min.js', function() {

				$(_container1).onePageNav({
					currentClass: 		'active',
					changeHash: 		false,
					scrollSpeed: 		750,
					scrollThreshold: 	0.5,
				...
				$("#topMain.nav-onepage li>a").bind("click", function() {
					if(window.width < 960) {
						$("button.btn-mobile").trigger('click');
					}
				});
		...
		// Bullet Navigation
		var _container2 = $("#nav-bullet");

		if(_container2.length > 0) {

			loadScript(plugin_path + '$.nav.min.js', function() {

				$(_container2).onePageNav({
					currentClass: 		'active',
					changeHash: 		false,
					scrollSpeed: 		750,
					scrollThreshold: 	0.5,
 ...
 **************************************************************** **/
	function _owl_carousel() {
		...
		// OWL CAROUSEL 2
		var _container2 = $("div.owl-carousel-2");
		...
		if(_container2.length > 0) {
			...
			loadScript(plugin_path + 'owl-carousel-2/owl.carousel.min.js', function() {
				...
				_container2.each(function() {
					...
					var _config = $.extend({}, _defaults, JSON.parse(_options));
 ...
 **************************************************************** **/
	function _lightbox() {
		...
		if(_el.length > 0) {
			...
			loadScript(plugin_path + 'magnific-popup.min.js', function() {
 ...
 **************************************************************** **/
	function _scrollTo(to, offset) {
		...
		if(to == false) {
			...
			$('html,body').animate({scrollTop: $(to).offset().top - offset}, 800, 'easeInOutExpo');
 ...
 **************************************************************** **/
	function _parallax() {
		...
		if($().parallax) {
			...
			$(".parallax-auto, .parallax-1, .parallax-2, .parallax-3, .parallax-4, section.page-header.page-header-parallax").each(function() {
				var _t = $(this);
			...
			if(_slider.hasClass('parallax-slider')) {
				...
				$(window).scroll(function() {
					...
					if(_currentTop < 768) {
						...
						$('#slider>div').css('top', (_currentTop*0.5 - Number(_offset)));
						if(!_slider.hasClass('parallax-slider-noopacity')) {
							$('#slider>div').css('opacity', (1 - _currentTop/_sliderH*1));
						}
					}
 ...
 **************************************************************** **/
	function _video() {
		...
		if($("section.section-video").length > 0) {
			var _t = $("section.section-video .section-container-video>video");
				_w = $(window).width();
				...
				if($().mb_YTPlayer) {
					...
					if(disableMobile === false) {
						...
						$("#video-volume").bind("click", function() {
							if($('i.fa', this).hasClass('fa-volume-down')) {
								$('i.fa', this).removeClass('fa-volume-down');
								$('i.fa', this).removeClass('fa-volume-up');
								$('i.fa', this).addClass('fa-volume-up');
							} else {
								$('i.fa', this).removeClass('fa-volume-up');
								$('i.fa', this).removeClass('fa-volume-v');
								$('i.fa', this).addClass('fa-volume-down');
							}
						});
		...
		if(_container.length > 0) {
			loadScript(plugin_path + 'mixitup.min.js', function() {
				...
				if($().mixitup) {
					...
					_container.mixitup();
					$("ul.mix-filter a").bind("click", function(e) {
						e.preventDefault();
					});
	...
	function _wrotate() {
		$(".word-rotator").each(function() {
			...
			var _t 				= $(this),
				...
				_cItem 			= 1,
				_cTop 			= 0,
				_delay 			= $(this).attr('data-delay') || 2000;
 ...
 **************************************************************** **/
	function _misc() {
		...
		if($("#portfolio").length > 0) {
			$("#portfolio .item-box .owl-carousel").each(function() {

				// Fix if has owl-carousel slider!
				$(this).parent().parent().find('.item-box-desc').css({"padding-top":"29px"});
		...
		/** Isotope Portfolio
		 *********************** **/
		var portfolio_isotope_container = $("#portfolio.portfolio-isotope");
				...
				if($().isotope) {
					...
					function _recalcW() {
						...
						if(_container.hasClass('fullwidth')) { // Fullwidth
							...
							$("#portfolio.portfolio-isotope").css({"width":_w});
							$("#portfolio>.portfolio-item").css({"width":_wItem});
		...
		/** Isotope Blog
		 *********************** **/
		var blog_isotope_container = $("#blog.blog-isotope");
				...
				if($().isotope) {
					...
					function _recalcW() {
						...
						if(_container.hasClass('fullwidth')) { // Fullwidth
							...
							// Apply item & container width
							$("#blog.blog-isotope").css({"width":_w});
							$("#blog>.blog-post-item").css({"width":_wItem});
					...
					$(window).on("load", function(){
						...
						var _t = setTimeout(function(){
							...
							$('#blog_filter>li>a').bind("click", function(e){
								...
								$('#blog_filter>li.active').removeClass('active');
								$(this).parent('li').addClass('active');
		...
		$("a.toggle-default").bind("click", function(e) {
			...
			if($(_href).is(":hidden")) {
				...
				$('i.fa', this).removeClass('fa-plus-square').addClass('fa-minus-square');
		 ...
		 *********************** **/
		var file_container = $("input[type=file]");
			...
			loadScript(plugin_path + 'countdown/$.countdown.pack.min.js', function() {
				...
				_container2.bind("click", function(e){
					...
					var _t = $(this),
						...
						_countdown		= $("#"+cd_container+' span.download-wait>.countdown'),
						_seconds 		= parseInt(_t.attr('data-seconds')),
						_dataURL		= _t.attr('href');

					_t.fadeOut(250, function(){
						$("#"+cd_container).fadeIn(250, function() {
							...
							_countdown.countdown({
								...
								expiryUrl: _dataURL,
								onExpiry: function(){
									$("#"+cd_container+' span.download-message').removeClass('hide');
									$("#"+cd_container+' span.download-wait').addClass('hide');
								}
							});
			...
			loadScript(plugin_path + 'toastr/toastr.js', function() {
				...
				_btn.bind("click", function(e) {
					...
					var _message 			= $(this).attr('data-message'),
						_notifyType 		= $(this).attr('data-notifyType')			|| "default",
						_position	 		= $(this).attr('data-position')			|| "top-right",
						_progressBar 		= $(this).attr('data-progressBar') 		== "true" ? true : false,
						_closeButton		= $(this).attr('data-closeButton') 		== "true" ? true : false,
						_debug		 		= $(this).attr('data-debug') 				== "true" ? true : false,
						_newestOnTop 		= $(this).attr('data-newestOnTop') 		== "true" ? true : false,
						_preventDuplicates	= $(this).attr('data-preventDuplicates') 	== "true" ? true : false,
						_showDuration 		= $(this).attr('data-showDuration') 		|| "300",
						_hideDuration 		= $(this).attr('data-hideDuration') 		|| "1000",
						_timeOut 			= $(this).attr('data-timeOut') 			|| "5000",
						_extendedTimeOut	= $(this).attr('data-extendedTimeOut')		|| "1000",
						_showEasing 		= $(this).attr('data-showEasing') 			|| "swing",
						_hideEasing 		= $(this).attr('data-hideEasing') 			|| "linear",
						_showMethod 		= $(this).attr('data-showMethod') 			|| "fadeIn",
						_hideMethod 		= $(this).attr('data-hideMethod') 			|| "fadeOut";
 ...
 **************************************************************** **/
	function _charts() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path + 'chart.easypiechart/dist/$.easypiechart.min.js', function() {
 ...
 **************************************************************** **/
	function _form() {
		...
		if($('form.validate-plugin').length > 0) {
			...
			loadScript(plugin_path + 'form.min.js', function() {
				loadScript(plugin_path + 'validation.min.js');
			});
		...
		if($('form.validate').length > 0) {
			...
			loadScript(plugin_path + 'form.min.js', function() {
				loadScript(plugin_path + 'validation.min.js', function() {
						...
						$('form.validate').each(function() {
							...
							_t.validate({
								submitHandler: function(form) {
									...
									// Show spin icon
									$(form).find('.input-group-addon').find('.fa-envelope').removeClass('fa-envelope').addClass('fa-refresh fa-spin');
									...
									$(form).ajaxSubmit({
										...
										success: 	function(data) {
											...
											// SUCCESS
												...
												// Remove spin icon
												$(form).find('.input-group-addon').find('.fa-refresh').removeClass('fa-refresh fa-spin').addClass('fa-envelope');
			...
			loadScript(plugin_path + 'editor.summernote/summernote.min.js', function() {
				...
				if($().summernote) {
					...
					_container_1.each(function() {
						...
						var _lang = $(this).attr('data-lang') || 'en-US';
 ...
 **************************************************************** **/
	function _infiniteScroll() {
		var _container 	= $(".infinite-scroll");

		if(_container.length > 0) {

			loadScript(plugin_path + 'infinite-scroll/$.infinitescroll.min.js', function() {
						...
						if(_id) {
							$('.zoom-more[data-for='+_id+'] a').bind("click", function(e) {
								...
								if(_href != "#") {
									...
									$('figure#'+_id + '>img').fadeOut(0, function() {
 ...
 **************************************************************** **/
	function _stepper() {
		var _container = $('input.stepper');

		if(_container.length > 0) {

			loadScript(plugin_path + 'form.stepper/$.stepper.min.js', function() {
 ...
 **************************************************************** **/
	function _slimScroll() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path + 'slimscroll/$.slimscroll.min.js', function() {
 ...
 **************************************************************** **/
	function _bgimage() {
		...
		var _t 	= $('section[data-background], section div[data-background]');
				...
				$(_t).each(function() {
					...
					if(data_background != '') {
						...
						/** NEXT|PREV
							...
							<a id="bs-prev" href="#"></a>
						**/
						$(".bs-next", _this).bind("click", function(e) {
							e.preventDefault();

							_this.data('backstretch').next();
						});

						$(".bs-prev", _this).bind("click", function(e) {
							e.preventDefault();
		...
		if(data_background != '') {
			...
			loadScript(plugin_path + '$.backstretch.min.js', function() {
				...
				if(data_background) {
					$.backstretch(data_background);
					$('body').addClass('transparent'); // remove backround color of boxed class
				}
	...
	function _widget_dribbble() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path + 'widget.dribbble/jribbble.min.js', function() {
					...
					$.jribbble.setToken(_token);

					$.jribbble.shots(_shots).rebounds().then(function(res) {
						var html = [];
...
/** Parallax
	http://www.ianlunn.co.uk/plugins/$-parallax/
 **************************************************************** **/
!function(n){n.fn.parallax=function(n,t,e){function o(){var o=$(window).scrollTop();r=e?function(n){return n.outerHeight(!0)}:function(n){return n.height()},i.each(function(){var e=$(this),i=e.offset().top,h=r(e);if(!(o>i+h||i>o+window.height)){var l=Math.round((u-o)*t);e.css("backgroundPosition",n+" "+l+"px")}})}var r,u,i=$(this);(arguments.length<1||null===n)&&(n="50%"),(arguments.length<2||null===t)&&(t=.1),(arguments.length<3||null===e)&&(e=!0),i.each(function(){u=i.offset().top,u<window.height&&(u=0)}),$(window).bind("scroll",o).resize(o),o()}}($);
